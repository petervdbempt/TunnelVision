...
if __name__ == "__main__":
    algorithm = "Informed Q-Switching (Epsilon-Visitation) With Separate Q-Tables"
    ...
    save_rewards_to_file("../TunnelVision/Data/TV_Q-Switching_Informed_Separate_EVAL.csv", average_rewards)
