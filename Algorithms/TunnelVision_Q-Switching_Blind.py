...
from AgentFunctions import (epsilon_greedy, greedy, visualize_visitation_counts, visualize_q_values,
                            save_rewards_to_file, plot_combined_subplots, evaluate_policy, blind_switching)
import numpy as np
import math
...
def q_learning(env, num_episodes, alpha, gamma, epsilon, visitation_bonus_weight, decay_rate):
    ...
    for episode in range(num_episodes):
        ...
        while not terminated:
            ...
            # Blind switching
            mode, intra_episodic_step_count = blind_switching(mode, intra_episodic_step_count)
    ...
    return Q, rewards, training, epsilons, modes
